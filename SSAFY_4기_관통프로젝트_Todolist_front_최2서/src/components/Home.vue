<template>
    <div id="test4" style="background-color :#FFFCD2">
        <v-layout row="row" wrap="wrap">
            ...
            <v-flex>
                <div>
                    <img alt="Vue logo" src="../assets/main.png" style="display: block; margin: 10% auto 0 auto;"/>
                </div>
                <div>
                    <img alt="Vue logo" src="../assets/main2.png" style="display: block; margin: 0 auto 0 auto;"/>
                </div>
            ...
            <div style="padding-top: 5%; margin: 0 auto; position: fixed; bottom: 5%; left: 22%;">
                <Header/>
            </div>
        </v-layout>
    </div>
