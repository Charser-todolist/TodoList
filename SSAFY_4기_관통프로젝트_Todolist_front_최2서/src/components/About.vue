<template>
    <v-container id="test4" style="background-color :#FFFCD2">
        <v-layout row="row" wrap="wrap">
                ...
                <div>
                    <div id="test7">
                        <ListAdd @listAdd="listAdd" @listEdit="listEdit"></ListAdd>
                         <v-date-picker id="test8" v-model="picker" @dblclick:date="dblClick"   color="orange lighten-1"></v-date-picker>
                    </div>
                </div>
                <div id="test7">
                    <List 
            ...
            <div style="margin: 0 auto; position: fixed; bottom: 5%; left: 22%;">
                <Header/>
            </div>
        </v-layout>
    </v-container>
